...
public interface BookingService {
    ...
    List<BookingFinishDto> findBookingsByOwner(long ownerId, String state, int from, int size);

    List<BookingFinishDto> getUserBookings(long userId, String state, int from, int size);
}
