...
class UserControllerTests {
    ...
    @Test
    void createUserWithIncorrectEmailStatusIsBadRequest() throws Exception {
        UserDto incorrectEmailUser = UserDto.builder()
                .name("Анна")
                .email("agwbu")
                .build();
        ...
        mockMvc.perform(post("/users")
                        .contentType("application/json")
                        .content(mapper.writeValueAsString(incorrectEmailUser)))
